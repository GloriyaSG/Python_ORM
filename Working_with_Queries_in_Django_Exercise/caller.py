...
def show_hard_dungeons():
    ...
    hard_dungeons = []
    for x in dungeons:
        hard_dungeons.append(f"{x.name} is guarded by {x.boss_name} who has {x.boss_health} health points!")
...
def show_workouts():
    ...
    for workout in workouts:
        printer.append(f"{workout.name} from {workout.workout_type} type has {workout.difficulty} difficulty!")
